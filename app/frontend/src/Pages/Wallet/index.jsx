		...
		<div className='h-[86vh] w-[100vw] flex flex-col items-center relative'>
			<div className="w-[100vw] h-[40vh] flex flex-col justify-center items-center z-10">
				...
				<div className="relative text-white flex mt-8 w-4/5">
					<TonConnectButton
						tonConnect={tonConnect} // Pass TonConnect instance
						...
						className="w-full h-12 bg-gradient-to-t from-[#2226FF] to-[#00B2FF] rounded-lg font-semibold text-sm"
						text="Connect Wallet"
						icon={<img src={HelmetIcon} alt="wallet_icon" width={20} />}
					/>
				</div>
			</div>
