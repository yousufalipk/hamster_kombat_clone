								...
								{inviteFriends.map((task, index) => {
									...
									return (
										<div
											...
											key={index}
											className={`bg-[#1B1B27] text-white flex justify-between items-center border ${task.claimed ? `border-[#224E00] shadow-[#224E00] shadow-sm` : `border-[#0099FF] shadow-[#0199FF] shadow-md`} rounded-[14px] gap-4 py-2 px-3 my-3`}
										>
											<div className="flex gap-3 justify-center items-center py-1 w-full">
												{/* Icon */}
												<div className="flex flex-shrink-0 ">
