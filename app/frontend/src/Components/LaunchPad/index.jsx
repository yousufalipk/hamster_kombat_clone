	...
	return (
		<>
			<div className='flex justify-evenly items-center px-3'>
				{/* Current Button */}
				<div
					className={`w-fit px-3 py-1 text-base font-medium cursor-pointer ${activeSubItem === "Current"
				...
				{/* TGE Button */}
				<div
					className={`w-fit px-3 py-1 text-base font-medium cursor-pointer ${activeSubItem === "TGE"
						? "text-[#FFF] pb-1 border-2 border-b-[#0072FF] border-t-0 border-r-0 border-l-0"
						: "text-[#BDBDBD]"
						}`}
				...
				{/* Missed Projects */}
				<div
					className={`w-fit px-3 py-1 text-base font-medium cursor-pointer ${activeSubItem === "Missed Projects"
						? "text-[#FFF] pb-1 border-2 border-b-[#0072FF] border-t-0 border-r-0 border-l-0"
						: "text-[#BDBDBD]"
						}`}
