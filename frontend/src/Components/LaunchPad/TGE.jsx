...
const TGE = () => {
	const { tgeToggle, setTgeToggle } = useUser();
	// launchpad || airtap

	const handleClickLaunchPad = () => {
		setTgeToggle('launchpad');
	}

	const handleClickAirTap = () => {
		setTgeToggle('airtap');
	}
