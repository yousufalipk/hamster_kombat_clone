...
var JWTService = /*#__PURE__*/function () {
  ...
  return _createClass(JWTService, null, [{
    ...
    key: "signRefreshToken",
    value: function signRefreshToken(payload, expiryTime) {
    ...
    value: function verifyAccessToken(token) {
      try {
    ...
    value: function () {
      var _storeRefreshToken = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(token, userId) {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 10:
              // Store new token
              newToken = new RefreshTokenModel({
                token: token,
                userId: userId
              });
              _context.next = 13;
            ...
            case 15:
              ...
              console.error('Error storing refresh token:', _context.t0);
            case 18:
            case "end":
      ...
      function storeRefreshToken(_x, _x2) {
