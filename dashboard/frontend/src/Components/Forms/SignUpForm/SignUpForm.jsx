  ...
  return (
    <div>
        ...
        <>
          <div className='flex flex-row justify-between'>
            ...
            <div className='w-2/4 max-10 flex flex-row justify-end'>
              ...
              <button
                className='mx-2 py-1 px-4 rounded-md bg-bluebtn text-white hover:bg-transparent hover:border-2 hover:border-bluebtn hover:text-bluebtn'
      ...
      <form onSubmit={formik.handleSubmit} className={`flex flex-col ${props.toggle ? 'w-2/4' : 'w-full'} mx-auto`}>
        ...
        {!props.toggle && (
          <button type='submit' className='bg-bluebtn w-36 p-3 mx-2 my-1 rounded-md text-white hover:bg-transparent hover:border-2 hover:border-bluebtn hover:text-bluebtn'>
            Create Account
          </button>
        )}
      </form>
